...
class Circle extends Logo {
    ...
    <circle cx="150" cy="107" r="80" fill="${this.shapeColor}" />
...
class Square extends Logo {
	...
	generateSquare() {
     ...
     width="300" height="200"
     xmlns="http://www.w3.org/2000/svg">
    <rect x="74" y="33" width="150" height="150" fill="${this.shapeColor}"/>
    <text x="150" y="125" font-size="60" text-anchor="middle" fill="${this.textColor}">${this.text}</text>
...
class Triangle extends Logo {
	...
	generateTriangle() {
     ...
     width="300" height="200"
     xmlns="http://www.w3.org/2000/svg">
    <polygon points="150,20 30,150 270,150" fill="${this.shapeColor}"/>
    <text x="150" y="125" font-size="60" text-anchor="middle" fill="${this.textColor}">${this.text}</text>
